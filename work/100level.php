...
<div>
    ...
    <p style="font-size:25px;" class="ba">100 LEVEL MATERIALS & PAST QUESTIONS</p>


    <div class="ta">
        <p style="font-size:20px;" class="p_head"><strong>100 LEVEL, HAMMATTAN AVAILABLE MATERIALS</strong> </p>
        <div class="q">
        <table class="table-bordered">
            ...
            <tr>
                <th>PHY 101</th>
                <th>Mechanics and Properties of Matter I</th>
            </tr>
            <tr>
                <th>PHY 103</th>
                <th>Basic Heat</th>
            ...
            <tr>
                <th>BIO 101</th>
                <th>Basic Principles of Biology</th>
            </tr>
            <tr>
                <th>CHM 101</th>
    ...
    <div class="material">
           <div class="pdf">
            <!-- <embed src="100Level file/csc_111_introduction_to_computer_systems_20182019.pdf" type=""> -->
            <p><b>download CSC 111 Material</b></p>
            <a class="btn btn-primary" href="100Level file/csc_111_introduction_to_computer_systems_20182019.pdf">download</a>
        </div>
        <div class="pdf">
            <!-- <embed src="100Level file/mat101.pdf" type=""> -->
             <p><b>download Mat 101 Material </b></p>
             <a class="btn btn-primary" href="100Level file/mat101.pdf">download</a>
         </div>
         <div class="pdf">
            <!-- <embed src="100Level file/Trigonometry_Short_Course_Tutorial_Lauren_Johnson.pdf" type=""> -->
             <p><b>download Mat 111 Material</b></p> 
             <a class="btn btn-primary" href="100Level file/mat101.pdf">download</a>
        </div>
        <div class="pdf">
    ...
    <div class="ta">
        <p style="font-size:20px;" class="p_head"><strong>100 LEVEL, RAIN AVAILABLE MATERIALS</strong> </p>
        <div class="q">
        <table class="table-bordered">
            <tr>
                <th>CODE</th>
            ...
            <tr>
                <th>CSC 120</th>
                <th>Computer as a Problem Solving Tool</th>
            </tr>
            <tr>
                <th>CSC 104</th>
                <th>Software Workshop</th>
            </tr>
            <tr>
                <th>CSC 112</th>
                <th>Principle of Computer Organisation</th>
            </tr>
            <tr>
                <th>CSC 132</th>
                <th>Principle of programming Language I</th>
            </tr>
            <tr>
                <th>MAT 112</th>
                <th>Calculus</th>
            ...
            <tr>
                <th>MAT 162</th>
                <th>Introduction to Statistics</th>
            </tr>
            <tr>
                <th>PHY 104</th>
                <th>Electricity and Magnetism I</th>
            </tr>
            <tr>
            <th>PHY 102</th>
            <th>Basic Optics and Sound</th>
            </tr>
            <tr>
                <th>GNS 102</th>
                <th>Use of Library</th>
